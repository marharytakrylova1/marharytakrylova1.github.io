...
export default function Aura({ width=100, height=100, deg=0, border=false }) {
    return (
        <div className={`relative -z-10 ${border && "border-4"}`} style={{width: `${width}px`, height: `${height}px`, transform: `rotate(${deg}deg)`}}>
            {/* Add aura background */}
